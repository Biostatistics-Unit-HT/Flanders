process MUNG_AND_LOCUS_BREAKER {
  ...
  stub:
    ...
    echo -e "${meta_study_id.study_id}\t1\t12345\trs123\tA\tT\t0.5\t1000\t0.1\t0.01\t0.001\tGWAS\t1\t0.5\tGRCh37\t0.05\t0.01\tNA\tNA\t0.1\t0.2\t0.01\tfalse\tdummy_key\t0.9\tfalse" >> ${meta_study_id.study_id}_loci_NO_HLA.tsv
    echo -e "${meta_study_id.study_id}\t2\t67890\trs456\tG\tC\t0.4\t2000\t0.2\t0.02\t0.002\tGWAS\t1\t0.6\tGRCh38\t0.04\t0.02\tNA\tNA\t0.2\t0.3\t0.02\ttrue\tdummy_key\t0.8\ttrue" >> ${meta_study_id.study_id}_loci_NO_HLA.tsv
